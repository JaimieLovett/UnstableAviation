...
part_type_color3(part_type_exhaust, c_lime, c_aqua, c_blue);
...
part_type_alpha3(part_type_asteroid_debris, .8, .8, 0);
...
part_type_sprite(part_type_ship_debris, sEnemyDebris, false, false, false);
